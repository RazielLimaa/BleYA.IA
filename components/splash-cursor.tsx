...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    class Program {
      ...
      constructor(vertexShader: WebGLShader | null, fragmentShader: WebGLShader | null, gl: WebGL2RenderingContext) {
    ...
    class Material {
      ...
      constructor(vertexShader: WebGLShader | null, fragmentShaderSource: string, gl: WebGL2RenderingContext) {
    ...
    const gradienSubtractProgram = new Program(baseVertexShader, gradientSubtractShader, gl)
    const displayMaterial = new Material(baseVertexShader, displayShaderSource, gl)
